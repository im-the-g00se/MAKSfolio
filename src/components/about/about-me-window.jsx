...
export function AboutMeWindow({ text, children, className }) {
    return (
        <div className={clsx("p-[5px] w-fit rounded-xl shadow-[0_0_3px_0_rgba(0,_0,_0,_0.55),_0_40px_100px_0_rgba(0,_0,_0,_0.20)]", className)}>
            <div className="text-neutral-500 font-semibold w-fit py-2 text-sm ">
                {text}
            </div>
